...
<nav class="navbar navbar-inverse">
	...
	<div class="container-fluid">
        <div class="navbar-header">
			<a style="color: whitesmoke; font-size:30px; word-spacing: 10px; font-family:Optima; line-height:10px ;" class="navbar-brand active">&nbspREAD BOOKS CHANGE THE WORLD</a>
		</div>				
...
<section>
	...
	<br><br><br>
	<div class="box1">
	<h1 style="color: whitesmoke;text-align: center; font-size: 35px; font-family: Courier;"> Welcome to the Library!</h1>
	<h1 style="color: whitesmoke; text-align: center; font-size: 25px; font-family: Courier;">Admin Login</h1>
